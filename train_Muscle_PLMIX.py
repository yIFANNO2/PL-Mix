...
if __name__ == '__main__':
    ...
    parser.add_argument("--gt", default="data/VOCdevkit/VOC2012/ImageSets/Segmentation", type=str)
    ...
    for ep in range(epsave, args.max_epoches):
       ...
       ##eval
        ...
        for t in range(20,52, 2):
            t /= 100.0
            loglist = do_python_eval(args.test_path, args.gt, name_list, 21, 'npy', t, printlog=False)
